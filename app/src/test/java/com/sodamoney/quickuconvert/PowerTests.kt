...
class PowerTests {
    ...
    fun testKilowatt() {
        ...
        val actual = Kilowatt.convertTo(BigDecimal(1), Watt)
    ...
    fun testMegawatt() {
        ...
        val actual = Megawatt.convertTo(BigDecimal(1), Watt)
        assertEquals((expected / actual).compareTo(BigDecimal(1)), 0)
    }
    ...
    fun testGigawatt() {
        ...
        val actual = Gigawatt.convertTo(BigDecimal(1), Watt)
        assertEquals((expected / actual).compareTo(BigDecimal(1)), 0)
    }
    ...
    fun testErgPerSecond() {
        ...
        val actual = ErgPerSecond.convertTo(BigDecimal(1), Watt)
        assertEquals((expected / actual).compareTo(BigDecimal(1)), 0)
    }
    ...
    fun testCaloriePerSecond() {
        ...
        val actual = CaloriePerSecond.convertTo(BigDecimal(1), Watt)
        assertEquals((expected / actual).compareTo(BigDecimal(1)), 0)
    }
    ...
    fun testBtuPerSecond() {
        ...
        val actual = BtuPerSecond.convertTo(BigDecimal(1), Watt)
        assertEquals((expected / actual).compareTo(BigDecimal(1)), 0)
    }
    ...
    fun testBtuPerMinute() {
        ...
        val actual = BtuPerMinute.convertTo(BigDecimal(1), Watt)
        assertEquals((expected / actual).compareTo(BigDecimal(1)), 0)
    }
    ...
    fun testTonOfRefrigeration() {
        ...
        val actual = TonOfRefrigeration.convertTo(BigDecimal(1), Watt)
        assertEquals((expected / actual).compareTo(BigDecimal(1)), 0)
    }
    ...
    fun testHorsePower() {
        ...
        val actual = HorsePower.convertTo(BigDecimal(1), Watt)
        assertEquals((expected / actual).compareTo(BigDecimal(1)), 0)
    }
    ...
    fun testMetricHorsePower() {
        ...
        val actual = MetricHorsePower.convertTo(BigDecimal(1), Watt)
        assertEquals((expected / actual).compareTo(BigDecimal(1)), 0)
    }
