...
class MomentTests {
    ...
    @Test
        fun testKilonewtonMeter() {
            ...
            val actual = KilonewtonMeter.convertTo(BigDecimal.ONE, NewtonMeter)
    ...
    @Test
        fun testNewtonCentimeter() {
            ...
            val actual = NewtonCentimeter.convertTo(BigDecimal.ONE, NewtonMeter)
            assertEquals((expected / actual).compareTo(BigDecimal.ONE), 0)
        }
    ...
    @Test
        fun testNewtonMillimeter() {
            ...
            val actual = NewtonMillimeter.convertTo(BigDecimal.ONE, NewtonMeter)
            assertEquals((expected / actual).compareTo(BigDecimal.ONE), 0)
        }
    ...
    @Test
        fun testKilogramForceMeter() {
            ...
            val actual = KilogramForceMeter.convertTo(BigDecimal.ONE, NewtonMeter)
            assertEquals((expected / actual).compareTo(BigDecimal.ONE), 0)
        }
    ...
    @Test
        fun testKilogramForceCentimeter() {
            ...
            val actual = KilogramForceCentimeter.convertTo(BigDecimal.ONE, NewtonMeter)
            assertEquals((expected / actual).compareTo(BigDecimal.ONE), 0)
        }
    ...
    @Test
        fun testKilogramForceMillimeter() {
            ...
            val actual = KilogramForceMillimeter.convertTo(BigDecimal.ONE, NewtonMeter)
            assertEquals((expected / actual).compareTo(BigDecimal.ONE), 0)
        }
    ...
    @Test
        fun testFootPound() {
            ...
            val actual = FootPound.convertTo(BigDecimal.ONE, NewtonMeter)
            assertEquals((expected / actual).compareTo(BigDecimal.ONE), 0)
        }
    ...
    @Test
        fun testFootKip() {
            ...
            val actual = FootKip.convertTo(BigDecimal.ONE, NewtonMeter)
            assertEquals((expected / actual).compareTo(BigDecimal.ONE), 0)
        }
    ...
    @Test
        fun testInchKip() {
            ...
            val actual = InchKip.convertTo(BigDecimal.ONE, NewtonMeter)
            assertEquals((expected / actual).compareTo(BigDecimal.ONE), 0)
        }
