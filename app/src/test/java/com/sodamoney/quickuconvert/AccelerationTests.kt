...
class AccelerationTests {
    ...
    fun testInchPerSecondSquared() {
        ...
        val actual = InchPerSecondSquared.convertTo(BigDecimal(1), MeterPerSecondSquared)
    ...
    fun testFootPerSecondSquared() {
        ...
        val actual = FootPerSecondSquared.convertTo(BigDecimal(1), MeterPerSecondSquared)
        assertEquals(expected.compareTo(actual), 0)
    }
    ...
    fun testCentimeterPerSecondSquared() {
        ...
        val actual = CentimeterPerSecondSquared.convertTo(BigDecimal(1), MeterPerSecondSquared)
        assertEquals(expected.compareTo(actual), 0)
    }
    ...
    fun testMillimeterPerSecondSquared() {
        ...
        val actual = MillimeterPerSecondSquared.convertTo(BigDecimal(1), MeterPerSecondSquared)
        assertEquals(expected.compareTo(actual), 0)
    }
    ...
    fun testEarthGravity() {
        ...
        val actual = EarthGravity.convertTo(BigDecimal(1), MeterPerSecondSquared)
